...
if(!isset($_SESSION["id"]) || $_SESSION["type"] != "3" ) {
   ...
   /* echo '<script>alert("enta msh admin ya dazma"); window.location.assign("profile.php");</script>';*/
    }else{
...
// get general data
$selectgeneraldata="SELECT * FROM general_information g JOIN nationaliity n ON g.nationality_id=n.nationality_id JOIN countries c ON g.country_id =c.country_id JOIN religion r ON g.religion_id =r.religion_id WHERE user_id='".$_SESSION['id']."'";
...
/*  get experiance data */
$selectexperiencesdata="SELECT * FROM `experiences` WHERE user_id='".$_SESSION['id']."'";
$runexperiences=mysqli_query($con , $selectexperiencesdata);



/*  get skills data   */
$selectskillsdata="SELECT * FROM skills   WHERE user_id='".$_SESSION['id']."'";
$runskills=mysqli_query($con , $selectskillsdata);


/*  get language data   */
$selectlanguage_listdata="SELECT * FROM language_list l JOIN languages g ON l.language_id = g.language_id JOIN language_level v ON l.level_lang_id = v.level_lang_id  WHERE user_id='".$_SESSION['id']."'";
$runlanguage_list=mysqli_query($con , $selectlanguage_listdata);


/*  get courses data */
$selectcoursestraindata="SELECT * FROM `coursestraining` WHERE user_id='".$_SESSION['id']."'";
$runcoursestrain=mysqli_query($con , $selectcoursestraindata);


/*  get online links data */
$selectonlinedata="SELECT * FROM `onlinelinks` WHERE user_id='".$_SESSION['id']."'";
$runonline=mysqli_query($con , $selectonlinedata);



/*  get CV data */
$selectCVdata="SELECT * FROM `uploadcv` WHERE user_id='".$_SESSION['id']."'";
$runCV=mysqli_query($con , $selectCVdata);

/*  get college data */
$selectcollegedata="SELECT * FROM `college` WHERE user_id='".$_SESSION['id']."'";
$runCollege=mysqli_query($con , $selectcollegedata);


/*  get Education data */
$selecteducationdata="SELECT * FROM education e JOIN degree_level d ON e.degree_id=d.degree_id JOIN grade g ON e.grade_id = g.grade_id  WHERE user_id='".$_SESSION['id']."'";
$runeducation=mysqli_query($con , $selecteducationdata);

/*  get college data */
$selectcertificationdata="SELECT * FROM `certification` WHERE user_id='".$_SESSION['id']."'";
...
<body>
    <section class="header">
        <nav class="navbar navbar-expand-lg p-0 navbarmenu">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                    <ul class="navbar-nav ml-auto ">
                        <li class="nav-item active mx-2">
                            <a class="nav-link" href="edite-profile-ar.php?user_id=<?php echo $_SESSION['id'] ?>">تعديل الصفحة الشخصية</a>
                        </li>
                        <li class="nav-item active mx-2">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-5">
                        <div class="caption ml-4">
                            ...
                            <a href="change-password-ar.php" class="change-pass">تغيير كلمة السر</a>
                        </div>
                    </div>
                            ...
                            <div class="general-info mt-3 pb-5">
                                ...
                                <div class="ml-5">
                                    <h5 class="py-2"><b>تاريخ الميلاد:</b><span>
                                            ...
                                            if (mysqli_num_rows($rungeneraldata)>0){
                                                $originalDateB = "{$fetchgeneral['birthday']}";
                                                $newDateB = date("d-m-Y", strtotime($originalDateB));

                                                echo $newDateB; } else { } ?>
                                        </span></h5>

                                    <?php if (mysqli_num_rows($runcareerdata)>0){
                                       $ssalary= intval($fetchcareer['salary']);
                                    echo " <h5 class='title-work py-2'><b>experience level:</b>   ".$fetchcareer['career_name']." </h5>
                                            <h5 class='title-work'> <b>Expected Salary:</b> <span> ".$ssalary."</span><span> ".$fetchcareer['currancy_name']."</span></h5>
                                ...
                                <div class="caption ml-5">
                                    ...
                                    if (mysqli_num_rows($runexperiences)>0){
                                        ...
                                        while ($fetchexperiences=mysqli_fetch_array($runexperiences)){
                                            ...
                                            echo '<p>من  <i class="icofont-long-arrow-right"></i> '.$newDateF.' / الي <i class="icofont-long-arrow-right"></i> '.$newDateT.' </p>';
